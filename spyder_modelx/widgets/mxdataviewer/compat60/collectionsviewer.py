# Modified from
# https://github.com/spyder-ide/spyder/blob/v6.0.4/spyder/widgets/collectionseditor.py
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if index.column() == 3:
            ...
            if is_type_text_string(value):
                display = str(value, encoding="utf-8") if isinstance(value, bytes) else str(value)
...
class MxCollectionsViewer(QWidget):   # mx_change
