# Modified from
# https://github.com/spyder-ide/spyder/blob/v6.0.4/spyder/plugins/variableexplorer/widgets/dataframeeditor.py
...
class DataFrameView(QTableView, SpyderWidgetMixin):
    ...
    def resize_to_contents(self, rows=False):
        ...
        if isinstance(self.parent(), MxDataFrameViewer):    # mx_change
            if rows:
...
class MxDataFrameViewer(QWidget, SpyderWidgetMixin):    # mx_change
    """
    ...
    def setup_ui(self, title: str) -> None:
        ...
        # self.dataModel.dataChanged.connect(self.save_and_close_enable)  # mx_change
        ...
        # self.setWindowFlags(Qt.Window)    # mx_change
    ...
    def set_data_and_check(self, data) -> bool:
        ...
        # self.btn_save_and_close.setDisabled(True)     # mx_change
    ...
    def create_table_level(self):
        ...
        # self.table_level.setItemDelegate(QItemDelegate())     # mx_change
    ...
    def create_table_header(self):
        ...
        # self.table_header.setItemDelegate(QItemDelegate())    # mx_change
    ...
    def create_table_index(self):
        ...
        self.table_index.verticalHeader().sectionResized.connect(
            self._row_resized)
        # self.table_index.setItemDelegate(QItemDelegate())     # mx_change
    ...
    def create_data_table(self):
        ...
        # self.dataTable.setItemDelegate(QItemDelegate())   # mx_change
