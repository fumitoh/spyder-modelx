# Modified from
# https://github.com/spyder-ide/spyder/blob/v6.0.4/spyder/plugins/variableexplorer/widgets/arrayeditor.py
...
class ArrayModel(QAbstractTableModel, SpyderFontsMixin):
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        if dtype == "bool":
            ...
            val = value.encode('utf8') if isinstance(value, str) else bytes(value)
...
class MxArrayViewer(QWidget, SpyderWidgetMixin):    # mx_change
    """Array Editor Dialog"""
